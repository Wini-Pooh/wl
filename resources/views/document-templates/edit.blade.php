            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Редактирование шаблона: {{ $template->name }}
                    </h3>
                </div>
                
                <form action="{{ route('document-templates.update', $template->id) }}" method="POST" id="templateForm">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select @error('document_type') is-invalid @enderror" 
                                                    ...
                                                    <option value="act" {{ old('document_type', $template->document_type) == 'act' ? 'selected' : '' }}>Акт выполненных работ</option>
                                                    <option value="invoice" {{ old('document_type', $template->document_type) == 'invoice' ? 'selected' : '' }}>Счет на оплату</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Краткое описание шаблона">{{ old('description', $template->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Введите содержимое шаблона">{{ old('content', $template->content) }}</textarea>
                                            <div class="form-text">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <form action="{{ route('document-templates.destroy', $template->id) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    @method('DELETE')
