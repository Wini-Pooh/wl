...
<head>
    ...
    @stack('styles')
    <!-- Vite Assets -->
    @vite(['resources/css/app.css', 'resources/css/mobile-utilities.css', 'resources/js/app.js'])
...
<body>
    ...
    <div id="app">
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    ...
                                    @if(Auth::user()->defaultRole)
                                        <span class="badge bg-secondary">{{ Auth::user()->defaultRole->name }}</span>
                                    @endif
                                </a>
        ...
        <script src="{{ asset('js/bootstrap-modal-fix.js') }}"></script>
