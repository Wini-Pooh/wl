        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Создание шаблона документа</h3>
                </div>
                ...
                <form id="templateForm">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="2"
                                              placeholder="Краткое описание назначения шаблона"></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="template_content" name="template_content" 
                                              rows="20" required placeholder="Введите содержимое шаблона. Используйте {{'{{переменная}}'}} для создания переменных"></textarea>
                                    <div class="form-text">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('documents.index', ['tab' => 'templates']) }}" class="btn btn-secondary">
    ...
    function updatePreview() {
        ...
        if (content.trim()) {
            ...
            let preview = content
                ...
                .replace(/\{\{contract_date\}\}/g, '24.07.2025')
        ...
        .then(data => {
            if (data.success) {
                ...
                if (data.errors) {
                    ...
                    showAlert('error', data.message || 'Произошла ошибка при создании шаблона');
                }
            }
        })
        .catch(error => {
            console.error('Error:', error);
            showAlert('error', 'Произошла ошибка при создании шаблона');
        })
        .finally(() => {
