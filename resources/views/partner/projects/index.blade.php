...
@section('styles')
<link href="{{ asset('css/mobile-project-list.css') }}" rel="stylesheet">
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="row flex justify-content-between d-flex mb-4 gap-3">
                ...
                <div class=" col-4 d-flex flex-column d-md-block w-100 w-md-auto" style="max-width: 300px">
                    <a href="{{ route('partner.projects.create') }}" class="btn btn-primary btn-create-mobile visible-mobile mb-2 touch-target">
                        <i class="bi bi-plus-circle me-2"></i>
                        Создать объект
                    </a>
                    <a href="{{ route('partner.projects.create') }}" class="btn btn-primary visible-desktop shadow-blue-hover">
                        <i class="bi bi-plus-circle me-2"></i>
                        Создать объект
                    </a>
                </div>
            ...
            <div class="filters-mobile-container d-md-none">
                ...
                <div class="collapse" id="filtersCollapseMobile">
                    <div class="p-3">
                        <form method="GET" action="{{ route('partner.projects.index') }}" id="filterFormMobile">
                            <input type="hidden" name="view_mode" value="{{ $viewMode ?? 'list' }}">
