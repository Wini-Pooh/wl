...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('partner.projects.store') }}" method="POST" id="projectForm">
                @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-text">
                                            <button type="button" class="btn btn-sm btn-outline-info" onclick="searchByPhone()">
                                                <i class="bi bi-search me-1"></i> Найти существующие объекты
                                            </button>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('object_type') is-invalid @enderror" 
                                            ...
                                            @foreach(\App\Models\Project::getObjectTypes() as $key => $label)
                                                <option value="{{ $key }}" {{ old('object_type') == $key ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('project_status') is-invalid @enderror" 
                                            ...
                                            @foreach(\App\Models\Project::getStatuses() as $key => $label)
                                                <option value="{{ $key }}" {{ old('project_status', 'draft') == $key ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="passport_issued_by" 
                                               name="passport_issued_by" value="{{ old('passport_issued_by') }}" 
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="passport_issued_date" 
                                               name="passport_issued_date" value="{{ old('passport_issued_date') }}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="passport_department_code" 
                                               name="passport_department_code" value="{{ old('passport_department_code') }}" 
                                               placeholder="123-456">
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="registration_house" 
                                               name="registration_house" value="{{ old('registration_house') }}" 
                                               placeholder="12">
                                    </div>
                                    <div class="col-md-1">
                                        ...
                                        <input type="text" class="form-control" id="registration_apartment" 
                                               name="registration_apartment" value="{{ old('registration_apartment') }}" 
                                               placeholder="45">
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control bg-light" id="work_cost" 
                                               name="work_cost" value="{{ old('work_cost', 0) }}" 
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control bg-light" id="materials_cost" 
                                               name="materials_cost" value="{{ old('materials_cost', 0) }}" 
                                               step="0.01" min="0" readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control bg-light" id="additional_work_cost" 
                                               name="additional_work_cost" value="{{ old('additional_work_cost', 0) }}" 
                                               step="0.01" min="0" readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control bg-light" id="total_cost" 
                                               name="total_cost" value="{{ old('total_cost', 0) }}" 
                                               readonly>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control" id="estimated_end_date" 
                                               name="estimated_end_date" value="{{ old('estimated_end_date') }}">
                                    </div>
                                    <div class="col-md-3">
