    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('partner.projects.documents.upload', $project ?? ['id' => 'PROJECT_ID']) }}" method="POST" enctype="multipart/form-data" id="uploadDocumentForm">
                    @csrf
                    <input type="hidden" id="documentProjectId" name="project_id" value="{{ $project->id ?? '' }}">
