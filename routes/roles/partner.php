...
Route::prefix('partner')->name('partner.')->group(function () {
    ...
    Route::middleware(['auth', 'role:partner,employee,foreman,estimator,admin'])->group(function () {
        ...
        Route::post('estimates/{estimate}/save-template', [App\Http\Controllers\Partner\EstimateController::class, 'saveAsTemplate'])->name('estimates.save-template');
    ...
    Route::middleware(['auth', 'role:partner,employee,admin'])->group(function () {
        Route::get('projects/create', [App\Http\Controllers\Partner\ProjectController::class, 'create'])->name('projects.create');
        Route::post('projects', [App\Http\Controllers\Partner\ProjectController::class, 'store'])->name('projects.store');
    ...
    Route::middleware(['auth', 'role:partner,employee,foreman,client,admin'])->group(function () {
        ...
        // Частичная загрузка финансовых данных для AJAX
        Route::get('finance/works', [App\Http\Controllers\Partner\ProjectFinanceController::class, 'getWorksPartial'])->name('finance.works');
