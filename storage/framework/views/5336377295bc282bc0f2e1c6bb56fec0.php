    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addStageForm" action="<?php echo e(route('partner.projects.stages.store', $project->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/projects/tabs/modals/stage-modal.blade.php ENDPATH**/ ?>