        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div class="mb-2 mb-md-0">
                    <h1 class="h3 mb-0">Проект #<?php echo e($project->id); ?> - <?php echo e($project->client_full_name); ?></h1>
                  
                </div>
                <div class="btn-group flex-wrap">
                    <?php if(\App\Helpers\UserRoleHelper::canManageProjects()): ?>
                    <a href="<?php echo e(route('partner.projects.edit', $project)); ?>" class="btn btn-outline-primary">
...
<!-- Модальные окна -->
<?php echo $__env->make('partner.projects.tabs.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/projects/show.blade.php ENDPATH**/ ?>