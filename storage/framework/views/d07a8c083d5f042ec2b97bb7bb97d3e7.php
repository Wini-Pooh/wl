                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <strong><?php echo e($work->name); ?></strong>
                                    <?php if($work->description): ?>
                                        <br><small class="text-muted"><?php echo e($work->description); ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="badge bg-light text-dark"><?php echo e(number_format($work->quantity, 2)); ?></span>
                        </td>
                        <td>
                            <span class="text-muted"><?php echo e($work->unit); ?></span>
                        </td>
                        <td>
                            <span class="text-success fw-semibold"><?php echo e(number_format($work->price, 2)); ?> ₽</span>
                        </td>
                        <td>
                            <span class="badge bg-primary text-white"><?php echo e(number_format($work->amount, 2)); ?> ₽</span>
                        </td>
                        <td>
                            <small class="text-info">
                                <i class="bi bi-calendar me-1"></i><?php echo e($work->created_at->format('d.m.Y')); ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/projects/finance/partials/works-partial.blade.php ENDPATH**/ ?>