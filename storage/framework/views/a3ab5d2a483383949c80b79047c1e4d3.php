        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="uploadPhotoForm" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="project_id" id="photoProjectId" value="<?php echo e($project->id); ?>">
...
<?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/projects/tabs/modals/photo-modal.blade.php ENDPATH**/ ?>