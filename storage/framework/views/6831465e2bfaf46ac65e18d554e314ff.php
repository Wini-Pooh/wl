                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e($project->client_full_name); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Телефон:</strong></td>
                                    <td><a href="tel:<?php echo e($project->client_phone); ?>"><?php echo e($project->client_phone); ?></a></td>
                                </tr>
                                <?php if($project->client_email): ?>
                                <tr>
                                    <td><strong>Email:</strong></td>
                                    <td><a href="mailto:<?php echo e($project->client_email); ?>"><?php echo e($project->client_email); ?></a></td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e($project->object_full_address); ?></td>
                                </tr>
                                <?php if($project->object_type): ?>
                                <tr>
                                    <td><strong>Тип объекта:</strong></td>
                                    <td><?php echo e($project->object_type); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($project->object_area): ?>
                                <tr>
                                    <td><strong>Площадь:</strong></td>
                                    <td><?php echo e($project->object_area); ?> м²</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-1"><?php echo e($event->description); ?></p>
