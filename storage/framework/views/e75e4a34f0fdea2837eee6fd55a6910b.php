...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <form action="<?php echo e(route('partner.employees.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              placeholder="Опишите основные обязанности и ответственность сотрудника..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              placeholder="Дополнительная информация, контакты, особенности работы..."><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a href="<?php echo e(route('partner.employees.index')); ?>" class="btn btn-outline-secondary me-3">
                                Отмена
                            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/employees/create.blade.php ENDPATH**/ ?>