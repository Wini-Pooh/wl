    ...
    <div class="row align-items-center mb-3 mb-md-4">
        ...
        <div class="col-12 col-md-4">
            <select id="periodSelect" class="form-select form-select-sm form-select-md-regular w-100">
                <option value="7" <?php echo e($period == 7 ? 'selected' : ''); ?>>7 дней</option>
                <option value="30" <?php echo e($period == 30 ? 'selected' : ''); ?>>30 дней</option>
                <option value="90" <?php echo e($period == 90 ? 'selected' : ''); ?>>90 дней</option>
                <option value="365" <?php echo e($period == 365 ? 'selected' : ''); ?>>Год</option>
            </select>
        </div>
    </div>
