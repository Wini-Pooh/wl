...
<div class="row mb-4">
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card">
            <div class="card-body text-center">
                <div class="display-4 text-primary"><?php echo e($data['total_projects'] ?? 0); ?></div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card">
            <div class="card-body text-center">
                <div class="display-4 text-success"><?php echo e($data['new_projects'] ?? 0); ?></div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card">
            <div class="card-body text-center">
                <div class="display-4 text-info"><?php echo e(number_format($data['avg_project_cost'] ?? 0, 0, ',', ' ')); ?> ₽</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card">
            <div class="card-body text-center">
                ...
                ?>
                <div class="display-4 text-warning"><?php echo e($activeProjects); ?></div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <?php if(isset($data['projects_by_status']) && count($data['projects_by_status']) > 0): ?>
                    <div class="row">
                        <?php $__currentLoopData = $data['projects_by_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $statusLabels = [
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                <div class="card border-<?php echo e($statusInfo['color']); ?>">
                                    <div class="card-body text-center">
                                        <i class="bi <?php echo e($statusInfo['icon']); ?> text-<?php echo e($statusInfo['color']); ?>" style="font-size: 2rem;"></i>
                                        <h4 class="mt-2 text-<?php echo e($statusInfo['color']); ?>"><?php echo e($count); ?></h4>
                                        <p class="card-text small"><?php echo e($statusInfo['label']); ?></p>
                                    </div>
                                </div>
                            </div>
...
<!-- Типы работ детально -->
<?php if(isset($data['projects_by_work_type']) && count($data['projects_by_work_type']) > 0): ?>
<div class="row mt-4">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                            <?php $__currentLoopData = $data['projects_by_work_type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $percentage = $totalWorkTypeProjects > 0 ? ($count / $totalWorkTypeProjects * 100) : 0;
                                ?>
                                <tr>
                                    <td><?php echo e($workTypeLabels[$type] ?? $type); ?></td>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex align-items-center justify-content-end">
                                            ...
                                            <span class="small"><?php echo e(number_format($percentage, 1)); ?>%</span>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function initProjectsCharts() {
    ...
    const projectsDynamics = <?php echo json_encode($data['projects_by_days'] ?? [], 15, 512) ?>;
    ...
    const projectsStatus = <?php echo json_encode($data['projects_by_status'] ?? [], 15, 512) ?>;
    ...
    const workTypes = <?php echo json_encode($data['projects_by_work_type'] ?? [], 15, 512) ?>;
    ...
    const objectTypes = <?php echo json_encode($data['projects_by_object_type'] ?? [], 15, 512) ?>;
...
<?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/analytics/tabs/projects.blade.php ENDPATH**/ ?>