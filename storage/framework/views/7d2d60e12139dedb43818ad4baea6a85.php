...
function renderWorks(works) {
    if (works.length === 0) {
        ...
        const canManage = <?php echo json_encode(\App\Helpers\UserRoleHelper::canManageProjects(), 15, 512) ?>;
    ...
    works.forEach(work => {
        ...
        const canManage = <?php echo json_encode(\App\Helpers\UserRoleHelper::canSeeActionButtons(), 15, 512) ?>;
...
<?php $__env->stopPush(); ?><?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/projects/tabs/finance.blade.php ENDPATH**/ ?>