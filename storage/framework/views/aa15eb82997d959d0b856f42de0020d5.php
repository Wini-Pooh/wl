    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card bg-gradient-primary ">
            <div class="card-body text-center">
                ...
                <div class="h4 mt-2"><?php echo e(number_format($data['conversion_rate'], 1)); ?>%</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card bg-gradient-success ">
            <div class="card-body text-center">
                ...
                <div class="h4 mt-2"><?php echo e(number_format($data['avg_project_duration'], 0)); ?></div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card bg-gradient-info ">
            <div class="card-body text-center">
                ...
                <div class="h4 mt-2"><?php echo e(number_format($data['client_satisfaction'], 1)); ?>%</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card analytics-card bg-gradient-warning ">
            <div class="card-body text-center">
                ...
                <div class="h4 mt-2"><?php echo e(number_format($data['profitability_ratio'], 1)); ?>%</div>
            ...
            <div class="card-body">
                ...
                <div class="mb-0">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span><strong><?php echo e(number_format($data['profitability_ratio'], 1)); ?>%</strong></span>
                    </div>
                    <div class="progress">
                        <div class="progress-bar bg-info" style="width: <?php echo e(min($data['profitability_ratio'], 100)); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="border-end pb-3">
                            <h4 class="text-warning"><?php echo e(number_format(2500000, 0, ',', ' ')); ?></h4>
...
function updateInteractiveChart(chartType) {
    ...
    fetch(`/partner/analytics/chart-data?type=${chartType}&period=<?php echo e($period); ?>`)
...
<?php /**PATH C:\OSPanel\domains\rem\resources\views/partner/analytics/tabs/general.blade.php ENDPATH**/ ?>