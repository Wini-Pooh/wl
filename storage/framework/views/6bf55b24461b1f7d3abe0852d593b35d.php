...
<head>
  ...
  <!-- Основной шрифт Inter для единого дизайна -->
    ...
    <!-- Mobile Enhancements -->
    <script src="<?php echo e(asset('js/mobile-enhancements.js')); ?>"></script>
                ...
                <div class="col-lg-6 order-lg-2 order-1">
                    <div class="auth-image-section">
                        <div class="auth-image-content">
                            <?php echo $__env->yieldContent('image-content'); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\OSPanel\domains\rem\resources\views/layouts/auth.blade.php ENDPATH**/ ?>